...
Started after some minor issues.
Create-react-app was getting a ton of deprecation warnings, including being incompatible with React 18.
I flipped over to Vite. I carefully checked the requirements, and have not touched index.html in /public, removed any dependancies, or modified /service/*.
Also, using vanilla react, just Vite as a bundler.

Adding tailwind and shadcn.
